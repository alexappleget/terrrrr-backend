...
<SwaggerUI url="/openapi/note/createNote.yaml" supportedSubmitMethods={[]} />
...
<SwaggerUI url="/openapi/note/getWorldNotes.yaml" supportedSubmitMethods={[]} />
...
<SwaggerUI url="/openapi/note/deleteNote.yaml" supportedSubmitMethods={[]} />
