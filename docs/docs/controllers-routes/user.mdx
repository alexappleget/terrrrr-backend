...
<SwaggerUI url="/openapi/user/signup.yaml" supportedSubmitMethods={[]} />
...
<SwaggerUI url="/openapi/user/signin.yaml" supportedSubmitMethods={[]} />
...
<SwaggerUI url="/openapi/user/signout.yaml" supportedSubmitMethods={[]} />
...
<SwaggerUI url="/openapi/user/fetchUser.yaml" supportedSubmitMethods={[]} />
