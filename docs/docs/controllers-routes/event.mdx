...
<SwaggerUI url="/openapi/event/createEvent.yaml" supportedSubmitMethods={[]} />
...
<SwaggerUI
  url="/openapi/event/getWorldEvents.yaml"
...
<SwaggerUI url="/openapi/event/joinEvent.yaml" supportedSubmitMethods={[]} />
...
<SwaggerUI url="/openapi/event/leaveEvent.yaml" supportedSubmitMethods={[]} />
