...
<SwaggerUI
  url="/openapi/world-membership/getAllMemberships.yaml"
...
<SwaggerUI
  url="/openapi/world-membership/getWorldMembership.yaml"
  supportedSubmitMethods={[]}
/>
...
<SwaggerUI
  url="/openapi/world-membership/updateMemberRole.yaml"
  supportedSubmitMethods={[]}
/>
